...
<html lang="en">
    ...
    <body class="hold-transition">
        ...
        <div class="row auth">
            <div class="d-none d-lg-inline-block d-xl-inline-block col-lg-7 min-vh-100" style="background: #ffc849 url('<?php echo e(asset('img/home.jpg')); ?>') center"></div>
            ...
            <div class="col-lg-5 text-white text-center min-vh-100">
                ...
                <p class="pt-5">Copyright © <?php echo e(date('Y')); ?> <a href="https://croz.net">CROZ</a></p>
            </div>
        </div>
